...
Group.new('StatusLineNC' , c.white        , c.mono1   , no)        -- status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
...
Group.new('Visual'       , c.blue         , c.none    , r)         -- Visual mode selection
...
Group.new('StartifyBracket' , c.purple , c.none , no)
Group.new('StartifyFile'    , c.yellow , c.none , no)
Group.new('StartifyNumber'  , c.blue   , c.none , no)
Group.new('StartifyPath'    , c.cyan   , c.none , b)
Group.new('StartifySlash'   , c.red    , c.none , no)
Group.new('StartifySection' , c.green  , c.none , b)
Group.new('StartifySpecial' , c.orange , c.none , no)
