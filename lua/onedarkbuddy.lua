...
Color.new('mono0'        , '#313640')
Color.new('mono1'        , '#343944')
Color.new('mono2'        , '#373d49')
Color.new('mono3'        , '#4b5263')
Color.new('mono4'        , '#5c6370')
Color.new('mono5'        , '#919baa')
Color.new('mono6'        , '#abb2bf')
...
Group.new('ColorColumn'  , c.none         , c.mono0   , no)        -- used for the columns set with 'colorcolumn'
...
Group.new('CursorLine'   , c.none         , c.mono0   , no)        -- Screen-line at the cursor, when 'cursorline' is set. Low-priority if foreground (ctermfg OR guigf) is not set.
...
Group.new('EndOfBuffer'  , c.mono0        , c.none    , no)        -- filler lines (~) after the last line in the buffer
Group.new('TermCursor'   , c.white        , c.none    , b + r)     -- cursor in a focused terminal
Group.new('TermCursorNC' , c.mono3        , c.none    , b + r)     -- cursor in an unfocused terminal
Group.new('ErrorMsg'     , c.red          , c.none    , no)        -- error messages on the command line
Group.new('VertSplit'    , c.mono0        , c.none    , b)         -- the column separating vertically split windows
Group.new('Folded'       , c.none         , c.mono3   , b)         -- line used for closed folds
Group.new('FoldColumn'   , c.none         , c.mono3   , no)        -- 'foldcolumn'
...
Group.new('LineNr'       , c.mono3        , c.none    , no)        -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
...
Group.new('NonText'      , c.mono4        , c.none    , no)        -- '~' and '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g. , ">" displayed when a double-wide character doesn't fit at the end of the line).
...
Group.new('Pmenu'        , c.white        , c.mono1   , no)        -- Popup menu: normal item.
Group.new('PmenuSel'     , c.black        , c.blue    , b)         -- Popup menu: selected item.
Group.new('PmenuSbar'    , c.none         , c.mono2   , no)        -- Popup menu: scrollbar.
Group.new('PmenuThumb'   , c.none         , c.mono3   , no)        -- Popup menu: Thumb of the scrollbar.
...
Group.new('SpecialKey'   , c.mono4        , c.none    , no)        -- Meta and special keys listed with ":map", also for text used to show unprintable characters in the text, 'listchars'. Generally: text that is displayed differently from what it really is.
...
Group.new('Whitespace'   , c.mono4        , c.none    , no)        -- "nbsp", "space", "tab" and "trail" in 'listchars'
...
Group.new('Comment'        , c.mono4        , c.none , no)    -- any comment
...
Group.new('SpecialComment' , c.mono5        , c.none , no)    -- special things inside a comment
...
-- Asciidoc
Group.new('asciidocListingBlock' , c.mono5 , c.none , no)
...
Group.new('cucumberTags'            , c.mono4  , c.none , b)
Group.new('cucumberDelimiter'       , c.mono4  , c.none , b)

-- CSS/Sass
Group.new('cssAttrComma'         , c.purple , c.none , no)
Group.new('cssAttributeSelector' , c.green  , c.none , no)
Group.new('cssBraces'            , c.mono5  , c.none , no)
...
Group.new('gitcommitComment'        , c.mono4                  , c.none                   , no)
...
Group.new('haskellType'             , g.Type       , g.Type       , g.Type)
Group.new('haskellWhere'            , c.purple     , c.none       , i)
Group.new('haskellImportKeywords'   , c.purple     , c.none       , no)
Group.new('haskellOperators'        , g.Operator   , g.Operator   , g.Operator)
Group.new('haskellDelimiter'        , g.Delimiter  , g.Delimiter  , g.Delimiter)
Group.new('haskellIdentifier'       , g.Identifier , g.Identifier , g.Identifier)
Group.new('haskellKeyword'          , g.Keyword    , g.Keyword    , g.Keyword)
Group.new('haskellNumber'           , g.Number     , g.Number     , g.Number)
Group.new('haskellString'           , g.String     , g.String     , g.String)
...
Group.new('htmlTag'            , c.mono5  , c.none  , no)
Group.new('htmlEndTag'         , c.mono5  , c.none  , no)
Group.new('MatchTag'           , c.red    , c.mono0 , ul + b)

-- JavaScript
Group.new('coffeeString'                      , c.green    , c.none , no)
Group.new('javaScriptBraces'                  , c.mono5    , c.none , no)
...
Group.new('jsNoise'                           , c.mono5    , c.none , no)
...
Group.new('javascriptEndColons'               , c.mono4    , c.none , no)
...
Group.new('jsonQuote'              , c.mono4  , c.none , no)
...
Group.new('markdownBold'             , c.none     , c.none , b)
Group.new('markdownItalic'           , c.none     , c.none , b)
Group.new('markdownCode'             , c.orange   , c.none , no)
Group.new('markdownCodeBlock'        , c.orange   , c.none , no)
...
Group.new('markdownH3'               , c.green    , c.none , b)
Group.new('markdownH4'               , c.green    , c.none , b)
Group.new('markdownH5'               , c.green    , c.none , b)
Group.new('markdownH6'               , c.green    , c.none , b)
...
Group.new('phpParent'       , c.mono4  , c.none , no)
...
Group.new('pugDocType'             , c.mono4  , c.none , i)
...
Group.new('vimHighlight'    , c.blue       , c.mono0    , no)
...
Group.new('zshSubstDelim'  , c.mono4  , c.none , no)
...
Group.new('SpecialComment'           , c.mono4 , c.none , no)
Group.new('rustCommentLine'          , c.mono4 , c.none , no)
Group.new('rustCommentLineDoc'       , c.mono4 , c.none , no)
Group.new('rustCommentLineDocError'  , c.mono4 , c.none , no)
Group.new('rustCommentBlock'         , c.mono4 , c.none , no)
Group.new('rustCommentBlockDoc'      , c.mono4 , c.none , no)
Group.new('rustCommentBlockDocError' , c.mono4 , c.none , no)
...
Group.new('netrwComment'  , c.mono4      , c.none , no)
Group.new('netrwList'     , c.blue_light , c.none , no)
Group.new('netrwHelpCmd'  , c.mono4      , c.none , no)
...
Group.new('StartifySpecial' , c.mono4  , c.none , no)
Group.new('StartifyHeader'  , c.green  , c.none , no)
Group.new('StartifyFooter'  , c.green  , c.none , no)

-- Telescope (nvim-telescope/telescope.nvim)
Group.new('TelescopeSelection'      , c.blue_dark , c.mono0  , b)
Group.new('TelescopeSelectionCaret' , c.purple    , c.mono0  , b)
Group.new('TelescopeMultiSelection' , c.orange    , c.none   , no)
Group.new('TelescopeNormal'         , c.white     , c.none   , no)
Group.new('TelescopeBorder'         , c.mono5     , c.none   , no)
Group.new('TelescopePromptBorder'   , c.mono5     , c.none   , no)
Group.new('TelescopeResultBorder'   , c.mono5     , c.none   , no)
Group.new('TelescopePreviewBorder'  , c.mono5     , c.none   , no)
...
Group.new('rainbowcol1' , c.purple , c.none , no)
Group.new('rainbowcol2' , c.red    , c.none , no)
Group.new('rainbowcol3' , c.orange , c.none , no)
Group.new('rainbowcol4' , c.yellow , c.none , no)
Group.new('rainbowcol5' , c.green  , c.none , no)
